#include "bainbrid/Test/test/SortJetCollectionsByGenJetPt.h"
...
// -----------------------------------------------------------------------------
//
SortJetCollectionsByGenJetPt::SortJetCollectionsByGenJetPt( const edm::ParameterSet& pset ) 
...
// -----------------------------------------------------------------------------
//
SortJetCollectionsByGenJetPt::~SortJetCollectionsByGenJetPt() {;}

// -----------------------------------------------------------------------------
//
void SortJetCollectionsByGenJetPt::produce( edm::Event& event, const edm::EventSetup& setup ) {
  ...
  { 
    ...
    if ( edm::isDebugEnabled() ) {
      ss << "[SortJetCollectionsByGenJetPt::" << __func__ << "]"
...
// // -----------------------------------------------------------------------------
// //
// bool SortJetCollectionsByGenJetPt::matchJetsByCaloTowers( const pat::Jet& jet1,
// 							  const pat::Jet& jet2 ) {
