...
process.source = cms.Source(
    "PoolSource",
    fileNames = cms.untracked.vstring('file:/data2/bainbrid/data/Exotica_GMSB_GM1g_229_SUSYPAT_V5_v1_00a24c1fa2b61c755cc684c50e9bc48c_patLayer1_1.root')
    )
