...
// -----------------------------------------------------------------------------
//
ComparePhi::ComparePhi( std::string& vectorial,
			std::string& tracks ) {
...

  {
    ...
    TCanvas* bias = new TCanvas("BiasX015","BiasY015",1);
    ...
    if ( vectorial_histo ) { 
      ...
      vectorial_histo->GetYaxis()->SetTitle("#phi bias [rads]");
      vectorial_histo->GetXaxis()->SetTitleOffset(1.2);
      vectorial_histo->GetYaxis()->SetTitleOffset(1.9);
      vectorial_histo->SetMaximum(0.005);
      vectorial_histo->SetMinimum(-0.005);
    ...
    if ( bias_legend ) {
      ...
      bias_legend->AddEntry(vectorial_histo,"Vectorial, tracks only (#DeltaR = 0.30)","P");
      bias_legend->AddEntry(tracks_histo,"Vectorial, tracks only (#DeltaR = 0.15)","P");
      bias_legend->Draw();  
    }

    bias->SaveAs("PhiBiasComparison-0.15.png");
...

  {
    ...
    if ( vectorial_histo ) { 
      vectorial_histo->GetXaxis()->SetTitle("E_{T}^{gen} [GeV]");
      vectorial_histo->GetYaxis()->SetTitle("#phi resolution [rads]");
      vectorial_histo->GetXaxis()->SetTitleOffset(1.2);
      vectorial_histo->GetYaxis()->SetTitleOffset(1.9);
      vectorial_histo->SetMaximum(0.12);
      vectorial_histo->SetMinimum(0.0);
      vectorial_histo->SetMarkerStyle(24);
      vectorial_histo->SetMarkerSize(1.0);
      vectorial_histo->Draw("histPE1");
    }
    ...
    resolution->SaveAs("PhiResolutionComparison-0.15.png");
