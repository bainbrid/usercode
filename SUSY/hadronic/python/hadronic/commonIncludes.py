...
#dead ECAL (data)
deadECALdata2om_250_300 = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
deadECALdata2eq_250_300 = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
deadECALdata3om_250_300 = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
#
deadECALdata2om_300_350 = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
deadECALdata2eq_300_350 = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
deadECALdata3om_300_350 = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
#
deadECALdata2om_350plus = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
deadECALdata2eq_350plus = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
deadECALdata3om_350plus = OP_DeadECALCut(0.3,0.5,30.,10,0,"./deadRegionList_GR10_P_V10.txt") #file for data
#
#dead ECAL (Monte Carlo)
deadECALmc2om_250_300   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
deadECALmc2eq_250_300   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
deadECALmc3om_250_300   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
#
deadECALmc2om_300_350   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
deadECALmc2eq_300_350   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
deadECALmc3om_300_350   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
#
deadECALmc2om_350plus   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
deadECALmc2eq_350plus   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
deadECALmc3om_350plus   = OP_DeadECALCut(0.3,0.5,30.,10,1,"./deadRegionList_START36_V9.txt") #file for MC
