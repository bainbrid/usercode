...
//   const uint nht = ht.size();
  ...
  bool qcd_present = false;
  if ( qcd_present ) {
    files.push_back(StringV(1,dir+"v51/Ratio__sm_pythia.root"));
    files.push_back(StringV(1,dir+"v50/Ratio__sm_pythia.root"));
    //files.push_back(StringV(1,dir+"v52/Ratio__sm_pythia.root"));
    //files.push_back(StringV(1,dir+"v51/Ratio__qcd_pythia.root"));
    //files.push_back(StringV(1,dir+"v52/Ratio__qcd_pythia.root"));
  }
  ...
  bool data = false;
  if ( data ) {
    files.push_back(StringV(1,dir+"v24/Ratio_sm_pythia+lm1.root"));
    files.push_back(StringV(1,dir+"v24/Ratio_sm_pythia+lm6.root"));
    files.push_back(StringV(1,dir+"v24/Ratio_sm_pythia.root"));
    files.push_back(StringV(1,dir+"v70/Ratio__data.root"));
    //files.push_back(StringV(1,dir+"v30/Ratio_HT_Run2011A.root"));
    //files.push_back(StringV(1,dir+"v25/Ratio_HT_Run2011A_AllReco_17June.root"));
    //files.push_back(StringV(1,dir+"v30/Ratio_HT_Run2011A_AllReco_17June.root"));
    //files.push_back(StringV(1,dir+"v30/Ratio_HT_Run2011A_L1OffSet.root"));
//     files.push_back(StringV(1,dir+"v24/Ratio_wjets_pythia.root"));
//     files.push_back(StringV(1,dir+"v24/Ratio_zinv_pythia.root"));
//     files.push_back(StringV(1,dir+"v24/Ratio_ttbar_pythia.root"));
//     files.push_back(StringV(1,dir+"v24/Ratio_top_pythia.root"));
  }
  ...
  if ( syst ) {
    if (false) {
      files.push_back(StringV(1,dir+"v50/Ratio__sm_pythia.root"));
      files.push_back(StringV(1,dir+"v50/Ratio__sm_wjets_50pc.root"));
      files.push_back(StringV(1,dir+"v50/Ratio__sm_wjets_150pc.root"));
      files.push_back(StringV(1,dir+"v50/Ratio__sm_zinv_50pc.root"));
      files.push_back(StringV(1,dir+"v50/Ratio__sm_zinv_150pc.root"));
      files.push_back(StringV(1,dir+"v50/Ratio__sm_ttbar_50pc.root"));
      files.push_back(StringV(1,dir+"v50/Ratio__sm_ttbar_150pc.root"));
      files.push_back(StringV(1,dir+"v50/Ratio__sm_top_50pc.root"));
      files.push_back(StringV(1,dir+"v50/Ratio__sm_top_150pc.root"));
    } else {
      StringV base; 
      base.push_back(dir+"v50/Ratio__wjets.root");
      base.push_back(dir+"v50/Ratio__zinv.root");
      base.push_back(dir+"v50/Ratio__ttbar.root");
      base.push_back(dir+"v50/Ratio__top.root");
      base.push_back(dir+"v50/Ratio__qcd_pythia.root");
      files.push_back(StringV(1,dir+"v50/Ratio__qcd_pythia.root"));
//       StringV tmp0(base); files.push_back(tmp0);
//       StringV tmp1(base); tmp1[0] = dir+"v50/Ratio__wjets_50pc.root"; files.push_back(tmp1);
//       StringV tmp2(base); tmp2[0] = dir+"v50/Ratio__wjets_150pc.root"; files.push_back(tmp2);
//       StringV tmp3(base); tmp3[1] = dir+"v50/Ratio__zinv_50pc.root"; files.push_back(tmp3);
//       StringV tmp4(base); tmp4[1] = dir+"v50/Ratio__zinv_150pc.root"; files.push_back(tmp4);
//       StringV tmp5(base); tmp5[2] = dir+"v50/Ratio__ttbar_50pc.root"; files.push_back(tmp5);
//       StringV tmp6(base); tmp6[2] = dir+"v50/Ratio__ttbar_150pc.root"; files.push_back(tmp6);
//       StringV tmp7(base); tmp7[3] = dir+"v50/Ratio__top_50pc.root"; files.push_back(tmp7);
//       StringV tmp8(base); tmp8[3] = dir+"v50/Ratio__top_150pc.root"; files.push_back(tmp8);
    }
  }
...
//   double numer_errh[nfile][nmulti][nat][npt][nht];
//   double numer_errl[nfile][nmulti][nat][npt][nht];
//   double denom[nfile][nmulti][nat][npt][nht];
//   double denom_errh[nfile][nmulti][nat][npt][nht];
//   double denom_errl[nfile][nmulti][nat][npt][nht];
...
//   int length[nfile][nmulti][nat][npt];
  ...
  DoubleVVVVV numer; resize( numer, nfile, nmulti, nat, npt, nht );
  DoubleVVVVV numer_errh; resize( numer_errh, nfile, nmulti, nat, npt, nht );
  DoubleVVVVV numer_errl; resize( numer_errl, nfile, nmulti, nat, npt, nht );
  DoubleVVVVV denom; resize( denom, nfile, nmulti, nat, npt, nht );
  DoubleVVVVV denom_errh; resize( denom_errh, nfile, nmulti, nat, npt, nht );
  DoubleVVVVV denom_errl; resize( denom_errl, nfile, nmulti, nat, npt, nht );
  DoubleVVVVV ratio; resize( ratio, nfile, nmulti, nat, npt, nht );
  DoubleVVVVV errh; resize( errh, nfile, nmulti, nat, npt, nht );
  DoubleVVVVV errl; resize( errl, nfile, nmulti, nat, npt, nht );
  IntVVVV length; resize( length, nfile, nmulti, nat, npt );
  ...
  if (print) {
	...
	for ( uint iat = 0; iat < nat; ++iat ) {
	  for ( uint iht = 0; iht < nht; ++iht ) {
	    ...
	    double neh = numer_errh[ifile][imulti][iat][iht][iht];
	    double nel = numer_errl[ifile][imulti][iat][iht][iht];
	    double d = denom[ifile][imulti][iat][iht][iht];
	    double deh = denom_errh[ifile][imulti][iat][iht][iht];
	    double del = denom_errl[ifile][imulti][iat][iht][iht];
...
//  		      << int(( r > 0. ? el/r : -1. )*100.) << ")" 
  ...
  for ( uint ifile = 0; ifile < nfile; ++ifile ) {
	...
	for ( uint ipt = 0; ipt < npt; ++ipt ) {
	  for ( uint iht = 0; iht < nht; ++iht ) {
	    ...
	    double d_errh = denom_errh[ifile][imulti][iat][ipt][iht];
	    double d_errl = denom_errl[ifile][imulti][iat][ipt][iht];
  ...
  if ( two_measurements ) {
	...
	for ( uint iat = 0; iat < nat; ++iat ) {
	  ...
	  double d2_errh = denom_errh[ifile][imulti][iat][2][2];
	  double d2_errl = denom_errl[ifile][imulti][iat][2][2];
  ...
  if ( mc_measurement ) {
	...
	for ( uint iat = 0; iat < nat; ++iat ) {
	  ...
	  if ( int(ifile) != data_file ) {
	    ...
	    double d2_errh = denom_errh[data_file][imulti][iat][2][2];
	    double d2_errl = denom_errl[data_file][imulti][iat][2][2];
  ...
  if (true) {
	...
	for ( uint ifile = 0; ifile < nfile; ++ifile ) {
	  ...
	  double n_err = numer_errh[ifile][imulti][iat][ht_bin][ht_bin];
	  //double n_err = numer_errl[ifile][imulti][iat][ht_bin][ht_bin];
	  
	  if ( mc_measurement ) {
	    n_val = numer[data_file][imulti][iat][ht_bin][ht_bin];
	    n_err = numer_errh[data_file][imulti][iat][ht_bin][ht_bin];
	    if ( int(ifile) != data_file ) {
	...
	for ( uint iat = 0; iat < nat; ++iat ) {
	  for ( uint iht = 0; iht < nht; ++iht ) {
	    ...
	    if ( choice == PLOT_NUMERATOR ) {
	      ...
	      erryh[ifile][imulti][iat][iht] = numer_errh[ifile][imulti][iat][iht][iht];
	      erryl[ifile][imulti][iat][iht] = numer_errl[ifile][imulti][iat][iht][iht];
	    } else if ( choice == PLOT_DENOMINATOR ) {
	      valx[ifile][imulti][iat][iht] = ht[iht] + ht_step[iht]/2. + axis_offset1*ifile;
	      errxh[ifile][imulti][iat][iht] = ht_step[iht]/2. + axis_offset1*ifile;
	      errxl[ifile][imulti][iat][iht] = ht_step[iht]/2. - axis_offset1*ifile;
	      valy[ifile][imulti][iat][iht] = denom[ifile][imulti][iat][iht][iht];
	      erryh[ifile][imulti][iat][iht] = denom_errh[ifile][imulti][iat][iht][iht];
	      erryl[ifile][imulti][iat][iht] = denom_errl[ifile][imulti][iat][iht][iht];
	...
	for ( uint iat = 0; iat < nat; ++iat ) {
	  ...
	  if ( choice == PLOT_NUMERATOR ) { 
 	  ...
 	  for ( uint ifile = 0; ifile < nfile; ++ifile ) {
	    ...
	    if (true) {
	      gr->Fit("pol0","Q0","",valx[ifile][imulti][iat][0]-1.e-6,valx[ifile][imulti][iat][last_bin]+1.e-6);
	      TF1* fit_c = (TF1*)gr->FindObject("pol0");
	      if ( fit_c ) {
