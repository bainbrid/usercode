...
int qcdBkgdEst() {
  ...
  bool test_ewk = false;
  bool test_sm = false;
  bool test_standard = false;
  bool test_signal = false;
  bool test_scaled = false;
  bool test_flat = false;

  bool note_ratios = false;
  bool note_22pb = false;
...
//   files.push_back("../../../results/batch/"+dir1.str()+"_1/"+dir2.str()+"/QcdBkgdEst_sm+lm1_ttbar_x5.root");
  ...
  if ( test_met ) {
    files.push_back("../../../results/batch/101028e_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028f_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028i_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028j_1/"+dir2.str()+"/QcdBkgdEst_data.root");
  }
  if ( test_mht ) {
    files.push_back("../../../results/batch/101028e_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028t_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028u_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028v_1/"+dir2.str()+"/QcdBkgdEst_data.root");
  }
  if ( test_x3 ) {
    files.push_back("../../../results/batch/101028i_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028j_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028p_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028q_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028m_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101028n_1/"+dir2.str()+"/QcdBkgdEst_data.root");
  }
  if ( test_scaled ) {
    files.push_back("../../../results/batch/101029p_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101029q_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101029e_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101029u_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101029v_1/"+dir2.str()+"/QcdBkgdEst_data.root");
  }
  if ( test_ewk ) {
...
//     files.push_back("../../../results/batch/"+dir1.str()+"_1/"+dir2.str()+"/QcdBkgdEst_ttbar.root");
  ...
  if ( test_flat ) {
    files.push_back("../../../results/batch/"+dir1.str()+"_1/"+dir2.str()+"/QcdBkgdEst_qcd.root");
    files.push_back("../../../results/batch/"+dir1.str()+"_1/"+dir2.str()+"/QcdBkgdEst_qcd.root");
    files.push_back("../../../results/batch/"+dir1.str()+"_2/"+dir2.str()+"/QcdBkgdEst_qcd.root");
    files.push_back("../../../results/batch/"+dir1.str()+"_2/"+dir2.str()+"/QcdBkgdEst_qcd.root");
  }

  if ( note_ratios ) { 
    //files.push_back("../../../results/batch/101102_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101106a_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101102_1/"+dir2.str()+"/QcdBkgdEst_sm.root");
    files.push_back("../../../results/batch/101102_1/"+dir2.str()+"/QcdBkgdEst_qcd.root");
  }

  if ( note_22pb ) { 
    files.push_back("../../../results/batch/101102a_1/"+dir2.str()+"/QcdBkgdEst_data.root");
    files.push_back("../../../results/batch/101102_1/"+dir2.str()+"/QcdBkgdEst_sm.root");
    files.push_back("../../../results/batch/101102_1/"+dir2.str()+"/QcdBkgdEst_qcd.root");
  }
...
//   files.push_back("../../../results/batch/"+dir1.str()+"_1/"+dir2.str()+"/QcdBkgdEst_data.root");
  ...
  std::string his_name = "Ht";
  std::vector<std::string> his;
  if ( test_met ) { his.resize(4,his_name); }
  if ( test_mht ) { his.resize(4,his_name); }
  if ( test_x3 ) { his.resize(6,his_name); }
  if ( test_scaled ) { his.resize(5,his_name); }
  if ( test_ewk ) { his.resize(4,his_name); }
  if ( test_sm ) { his.resize(3,his_name); }
  if ( test_standard ) { his.resize(4,his_name); }
  if ( test_signal ) { his.resize(5,his_name); }
  if ( note_ratios ) { his.resize(3,his_name); }
  if ( note_22pb ) { his.resize(3,his_name); }
  if ( test_flat ) {
    his.push_back("Ht"); 
    his.push_back("GenHtNoMet"); 
    his.push_back("Ht"); 
    his.push_back("GenHtNoMet"); 
  }
  ...
  if ( test_met ) { 
    type.push_back("MHT/MET<1.25");
    type.push_back("MHT/MHT<1.3");
    type.push_back("pfMET<0.1");
    type.push_back("caloMET<0.1");
  }
  if ( test_scaled ) { 
    type.push_back("pf");
    type.push_back("calo");
  ...
  if ( test_mht ) {
    type.push_back("unscaled");
    type.push_back("scaled");
    type.push_back("fixed");
    type.push_back("ratio");
  }
  if ( test_x3 ) { 
    type.push_back("pfMET<0.1");
    type.push_back("caloMET<0.1");
    type.push_back("pfMET<0.125");
    type.push_back("caloMET<0.125");
    type.push_back("pfMET<0.15");
    type.push_back("caloMET<0.15");
  }
  if ( test_ewk ) {
  ...
  if ( test_flat ) {
    ...
    type.push_back("truth (scaled)");
    type.push_back("reco (fixed)");
    type.push_back("truth (fixed)");
  }
  if ( note_ratios ) {
    type.push_back("Data");
    type.push_back("SM");
...
//   type.push_back("15/pb");
//   type.push_back("22/pb");
...
//   type.push_back("data");
  ...
  //lumis.push_back(8.141e+03); // ttbar NLO
  //lumis.push_back(3.590e+02); // EWK 
  //lumis.push_back(4.282e+00); // QCD
  ...
  for ( uint itype = 0; itype < nfile; ++itype ) {
    if ( type[itype] == "data" || 
	 type[itype] == "Data" ) { data_file = itype; }
  }
  if ( data_file == -1 ) { 
...
// 	  // Numerator only
// 	  double n_val = b1_val * b1_val;
// 	  double n_errh = 2. * b1_errh * b1_val;
// 	  double n_errl = 2. * b1_errl * b1_val;
	  
// 	  // Add denominator
// 	  double d_val = b0_val;
// 	  double d_errh = b0_errh;
// 	  double d_errl = b0_errl;
	  
// 	  // Predicted ratio for HT=350
// 	  double r2_val = d_val > 0. ? n_val / d_val : 0.;
// 	  double r2_errh = 0.;
// 	  double r2_errl = 0.;
...
//   } // two_measurements
  ...
  if (true) {
	...
	c1->SetLineColor(0); 
	TH1D* difference = 0;
	if ( syst_ratio ) { difference = new TH1D(ss.str().c_str(),ss.str().c_str(),8000,-40.,40.); }
	else              { difference = new TH1D(ss.str().c_str(),ss.str().c_str(),8000,-40.,40.); }
	for ( uint ifile = 0; ifile < nfile; ++ifile ) {
	  //if ( int(ifile) == data_file ) { continue; }
	  if ( syst_ratio ) {
	    if ( predicted_val[ifile][imulti][iat] != 0. ) {
	      difference->Fill( observed[ifile][imulti][iat]/predicted_val[ifile][imulti][iat], 1. );
	    }
	  } else {
	...
	c1->cd();
	difference->Draw("h");
	c1->SaveAs(TString(ss.str()+".png")); 
	c1->SaveAs(TString(ss.str()+".pdf")); 
      }
    }
...
// 	}
	...
	if ( !xval.empty() ) {
      ...
      c1->SaveAs("DifferenceVsAlphaT.pdf"); 
...
//   }
  ...
  if ( plots ) {
	...
	for ( uint iat = 0; iat < nat; ++iat ) {
	  ...
	  TLegend* legend = new TLegend( 0.2, 0.79, 0.4, 0.91, NULL, "brNDC" );
	  //TLegend* legend = new TLegend( 0.7, 0.6, 0.9, 0.75, NULL, "brNDC" );
	  ...
	  TLatex* lumitxt = new TLatex( 0.51, 0.87, ssl.str().c_str() );
	  lumitxt->SetTextSize(0.04);
	  lumitxt->SetNDC();
