...
void JPTRootAnalysis::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("MassGen1", &MassGen1, &b_MassGen1);
   fChain->SetBranchAddress("MassRaw1", &MassRaw1, &b_MassRaw1);
   fChain->SetBranchAddress("MassZSP1", &MassZSP1, &b_MassZSP1);
   fChain->SetBranchAddress("MassJPT1", &MassJPT1, &b_MassJPT1);
   ...
   fChain->SetBranchAddress("MassGen2", &MassGen2, &b_MassGen2);
   fChain->SetBranchAddress("MassRaw2", &MassRaw2, &b_MassRaw2);
   fChain->SetBranchAddress("MassZSP2", &MassZSP2, &b_MassZSP2);
   fChain->SetBranchAddress("MassJPT2", &MassJPT2, &b_MassJPT2);
